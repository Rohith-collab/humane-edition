...
const GameArena = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <Card className="bg-black/60 backdrop-blur-md border-gray-700/50 hover:border-electric-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer group h-full flex flex-col">
              <CardHeader className="pb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-electric-500 to-electric-600 rounded-xl flex items-center justify-center mb-4 glow-electric group-hover:scale-110 transition-all duration-300">
                  <Type className="h-6 w-6 text-white" />
                </div>
                <CardTitle className="text-white text-xl group-hover:text-electric-400 transition-colors duration-300">
                  Word Building Battles
                </CardTitle>
              </CardHeader>
              <CardContent className="flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center text-xs text-gray-400">
                      <div className="w-1 h-1 bg-electric-400 rounded-full mr-2"></div>
                      Random letters
                    </div>
                    <div className="flex items-center text-xs text-gray-400">
                      <div className="w-1 h-1 bg-electric-400 rounded-full mr-2"></div>
                ...
                <div className="space-y-3 mt-6">
                  <Button className="w-full bg-gradient-to-r from-electric-500 to-electric-600 hover:from-electric-600 hover:to-electric-700 text-white transition-all duration-300">
                    Play Now
                  </Button>
                  <Button variant="outline" className="w-full border-gray-600 text-gray-300 hover:border-white hover:text-white transition-all duration-300">
                    Learn More
                  </Button>
                </div>
              </CardContent>
            ...
            {/* Grammar Detective */}
            <Card className="bg-black/60 backdrop-blur-md border-gray-700/50 hover:border-cyber-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer group h-full flex flex-col">
              <CardHeader className="pb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-cyber-500 to-cyber-600 rounded-xl flex items-center justify-center mb-4 glow-cyber group-hover:scale-110 transition-all duration-300">
                  <Search className="h-6 w-6 text-white" />
                </div>
                <CardTitle className="text-white text-xl group-hover:text-cyber-400 transition-colors duration-300">
                  Grammar Detective
                </CardTitle>
              </CardHeader>
              <CardContent className="flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center text-xs text-gray-400">
                      <div className="w-1 h-1 bg-cyber-400 rounded-full mr-2"></div>
                      Instant feedback
                    </div>
                    <div className="flex items-center text-xs text-gray-400">
                      <div className="w-1 h-1 bg-cyber-400 rounded-full mr-2"></div>
                ...
                <div className="space-y-3 mt-6">
                  <Button className="w-full bg-gradient-to-r from-cyber-500 to-cyber-600 hover:from-cyber-600 hover:to-cyber-700 text-white transition-all duration-300">
                    Play Now
                  </Button>
                  <Button variant="outline" className="w-full border-gray-600 text-gray-300 hover:border-white hover:text-white transition-all duration-300">
                    Learn More
            ...
            {/* Survival Mode */}
            <Card className="bg-black/60 backdrop-blur-md border-gray-700/50 hover:border-red-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer group h-full flex flex-col">
              <CardHeader className="pb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center mb-4 glow group-hover:scale-110 transition-all duration-300">
                  <AlertTriangle className="h-6 w-6 text-white" />
                </div>
                <CardTitle className="text-white text-xl group-hover:text-red-400 transition-colors duration-300">
                  Survival Mode
                </CardTitle>
              </CardHeader>
              <CardContent className="flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  <p className="text-gray-300 text-sm leading-relaxed">
                    One life. Rising difficulty. Miss once and it's game over.
                  </p>
                ...
                <div className="space-y-3 mt-6">
                  <Button className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white transition-all duration-300">
                    Play Now
                  </Button>
                  <Button variant="outline" className="w-full border-gray-600 text-gray-300 hover:border-white hover:text-white transition-all duration-300">
                    Learn More
            ...
            {/* Jumbled Words */}
            <Card className="bg-black/60 backdrop-blur-md border-gray-700/50 hover:border-nova-500/50 transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer group h-full flex flex-col">
              <CardHeader className="pb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-nova-500 to-nova-600 rounded-xl flex items-center justify-center mb-4 glow group-hover:scale-110 transition-all duration-300">
                  <Shuffle className="h-6 w-6 text-white" />
                </div>
                <CardTitle className="text-white text-xl group-hover:text-nova-400 transition-colors duration-300">
                  Jumbled Words
                </CardTitle>
              </CardHeader>
              <CardContent className="flex-1 flex flex-col justify-between">
                <div className="space-y-4">
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Unscramble letters into correct words under a timer.
                  </p>

                  <div className="space-y-1">
                    <div className="flex items-center text-xs text-gray-400">
                      <div className="w-1 h-1 bg-nova-400 rounded-full mr-2"></div>
                      Category filters
                    </div>
                    <div className="flex items-center text-xs text-gray-400">
                      <div className="w-1 h-1 bg-nova-400 rounded-full mr-2"></div>
                ...
                <div className="space-y-3 mt-6">
                  <Button className="w-full bg-gradient-to-r from-nova-500 to-nova-600 hover:from-nova-600 hover:to-nova-700 text-white transition-all duration-300">
                    Play Now
                  </Button>
                  <Button variant="outline" className="w-full border-gray-600 text-gray-300 hover:border-white hover:text-white transition-all duration-300">
                    Learn More
