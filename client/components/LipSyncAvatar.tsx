...
const avatarData = {
  interviewer: {
    ...
    background:
      "https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?w=1920&h=1080&fit=crop", // Office background
  },
  teacher: {
    image:
      "https://images.unsplash.com/photo-1559209172-e8d4c2d4b5e3?w=800&h=600&fit=crop&crop=face",
    name: "Sarah Williams",
    title: "Grammar Teacher",
    colors: "from-green-500 to-emerald-600",
    background:
      "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=1920&h=1080&fit=crop", // Library/classroom background
  },
  waiter: {
    image:
      "https://images.unsplash.com/photo-1583195764036-6dc248ac07d9?w=800&h=600&fit=crop&crop=face",
    name: "David Martinez",
    title: "Restaurant Server",
    colors: "from-amber-500 to-orange-600",
    background:
      "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=1920&h=1080&fit=crop", // Restaurant background
  },
  assistant: {
    image:
    ...
    background:
      "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1920&h=1080&fit=crop", // Store background
  },
};
                ...
                <div className="relative">
                  ...
                  <div
                    className={cn(
                      ...
                      speaking || isLoading
                        ? mouthState === 0
                          ? "bg-red-900/80 scale-75"
                          : mouthState === 1
                            ? "bg-red-800/80 scale-100"
                            : mouthState === 2
                              ? "bg-red-900/80 scale-125"
